  ...
  const getFullInfo = (song) => {
    return (
      <>
        ...
        <p>
          Author: <span className="song__title">{song.author}</span>
        </p>
        <p>
          Title: <span className="song__title">{song.title}</span>
        </p>
        <p>
          Duration: <span className="song__title">{song.duration}</span>
        </p>
      </>
    );
  };
  return (
    <div>
      {!props.selectedSong ? (
        ...
        getFullInfo(props.selectedSong)
      )}
    </div>
  );
};
